        ...
        <table class="table table-bordered table-striped align-middle">
          ...
          <tbody>
            ...
            <tr>
              ...
              <strong>อุปกรณ์ : ก้อนไม้สี่เหลี่ยมลูกบาศก์ 8 ก้อน</strong>
            </td>
              <td>
            ...
            <tr>
              ...
              <strong>อุปกรณ์ : ชุดก้อนไม้สี่เหลี่ยม ลูกบาศก์ 3 ก้อน</strong>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>สนใจฟังนิทานได้นาน 5 นาที(RL)<br><br>
                <strong>อุปกรณ์ : หนังสือนิทานสำหรับเด็กที่มีรูปภาพและคำอธิบายประกอบหน้าละประมาณ 20 - 30 คำ และอ่านจบใน 5 นาที</strong>
                </td>
              <td>
            ...
            <tr>
              ...
              <td>วางวัตถุไว้ “ข้างบน” และ“ข้างใต้” ตามคำสั่งได้ (RL)<br><br>
                <strong>อุปกรณ์ : ก้อนไม้สี่เหลี่ยมลูกบาศก์ 1 ก้อน</strong>
                </td>
              <td>
            ...
            <tr>
              ...
              <td>พูดติดต่อกัน 2 คำขึ้นไปอย่างมีความหมายโดยใช้คำกริยาได้ถูกต้องอย่างน้อย 4 กริยา (EL)<br><br>
                <strong>อุปกรณ์ : ตุ๊กตาผ้า</strong>
                </td>
              <td>
            ...
            <tr>
              ...
              <td>เด็กรู้จักรอให้ถึงรอบของตนเองในการเล่นโดยมีผู้ใหญ่คอยบอก (PS)<br><br>
                <strong>อุปกรณ์ :  1. ก้อนไม้ 4 ก้อน 
                    2. ถ้วยสำหรับใส่ก้อนไม้ 1 ใบ</strong>
                </td>
              <td>

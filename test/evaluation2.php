  ...
  <div class="container py-5">
    ...
    <form method="POST" action="" autocomplete="off">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                <span style="color: red;"><strong>ของเล่นที่ใช้แทนได้:</strong> อุปกรณ์ที่มีสีและเสียง เช่น กรุ๊งกริ๊งทำด้วยพลาสติก/ผ้า ลูกบอลยางบีบ/สัตว์ยางบีบ ขวดพลาสติกใส่เม็ดถั่ว/ทรายพันให้แน่น</span>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                ...
                <span style="color: red;"><strong>ของเล่นที่ใช้แทนได้:</strong>อุปกรณ์ที่มีสีสดใส เส้นผ่านศูนย์กลางประมาณ10 ซม. เช่น ผ้า/ลูกบอลผ้า พู่ไหมพรม</span>
              </td>
            </tr>
      ...
      <div class="d-block d-md-none">
        ...
        <div class="card mb-4 shadow-sm">
          <div class="card-header bgeva1 text-white">
            <h5 class="mb-0">ข้อที่ 7 - มองตามผ่านกึ่งกลางลำตัว(FM)</h5>
          </div>
          <div class="card-body bg-white">
            <div class="mb-3">
              <strong>อายุ:</strong> 1 - 2 เดือน
            ...
            <div class="mb-3">
              <strong>วิธีประเมิน:</strong><br>
              <p class="text-muted">1. จัดให้เด็กอยู่ในท่านอนหงาย ถือลูกบอลผ้าสีแดงห่างจากหน้าเด็ก 30 ซม. โดยให้อยู่เยื้องจุดกึ่งกลางลำตัวเด็กเล็กน้อย<br>
                2. กระตุ้นให้เด็กจ้องมองที่ลูกบอลผ้าสีแดง<br>
                3. เคลื่อนลูกบอลผ้าสีแดงผ่านจุดกึ่งกลางลำตัวเด็กไปอีกด้านหนึ่งอย่างช้า ๆ</p>
              <p><strong>ผ่าน:</strong>  เด็กมองตามลูกบอลผ้าสีแดง ผ่านจุดกึ่งกลางลำตัวได้ตลอด โดยไม่หันไปมองทางอื่น</p>
            </div>
            <div class="accordion" id="training7">
              <div class="accordion-item">
                ...
                <div id="collapse7" class="accordion-collapse collapse" data-bs-parent="#training7">
                  <div class="accordion-body">
                    1. จัดให้เด็กอยู่ในท่านอนหงาย ยื่นใบหน้าห่างจากหน้าเด็กประมาณ20 ซม. กระตุ้นให้เด็กมองหน้าและเคลื่อนใบหน้าผ่านกึ่งกลางลำตัวเพื่อให้เด็กมองตาม<br>
                    2. ถ้าเด็กไม่มองให้ประคองหน้าเด็กให้หันมองตาม หลังจากที่เด็กสามารถมองตามใบหน้าได้แล้ว ให้ถือของเล่นที่มีสีสดใสห่างจากหน้าเด็กประมาณ 20 ซม. 
                    กระตุ้นให้เด็กมองที่ของเล่น และเคลื่อนของเล่นผ่านกึ่งกลางลำตัวเพื่อให้เด็กมองตาม<br>
                    3. เมื่อเด็กมองตามได้ดีแล้ว ควรเพิ่มระยะห่างของใบหน้า หรือของเล่นจนถึงระยะ 30 ซม<br>
                    <span style="color: red;"><strong>ของเล่นที่ใช้แทนได้:</strong>อุปกรณ์ที่มีสีสดใส เส้นผ่านศูนย์กลางประมาณ10 ซม. เช่น ผ้า/ลูกบอลผ้า พู่ไหมพรม</span>
                  </div>
                </div>
        ...
        <div class="card mb-4 shadow-sm">
          <div class="card-header bgeva1 text-white">
            <h5 class="mb-0">ข้อที่ 8 - มองหน้าผู้พูดคุย ได้นาน 5 วินาที (RL)</h5>
          </div>
          <div class="card-body bg-white">
            <div class="mb-3">
              <strong>อายุ:</strong> 1 - 2 เดือน
            ...
            <div class="mb-3">
              <strong>วิธีประเมิน:</strong><br>
              <p class="text-muted">1. จัดให้เด็กอยู่ในท่านอนหงายหรืออุ้มเด็กให้ใบหน้าผู้ประเมินห่างจากเด็กประมาณ 30 ซม.<br>
              2. พูดคุยกับเด็กในขณะที่เด็กไม่ได้มองหน้าผู้ประเมิน</p><br>
              <p><strong>ผ่าน:</strong> เด็กหันมามองหน้าผู้พูดได้อย่างน้อย5 วินาที</p>
            </div>
        ...
        <div class="card mb-4 shadow-sm">
          <div class="card-header bgeva1 text-white">
            <h5 class="mb-0">ข้อที่ 9 - ทำเสียงในลำคอ (เสียง “อู”หรือ “อา” หรือ “อือ”) อย่างชัดเจน (EL)</h5>
          </div>
          <div class="card-body bg-white">
            <div class="mb-3">
              <strong>อายุ:</strong> 1 - 2 เดือน
            ...
            <div class="mb-3">
              <strong>วิธีประเมิน:</strong><br>
              <p class="text-muted">ฟังเสียงเด็กขณะประเมินเสียงเด็กขณะประเมิน โดยอยู่ห่างจากเด็กประมาณ 60 ซม. หรือถามจากพ่อแม่ผู้ปกครองหรือผู้ดูแลเด็ก ว่าเด็กทำเสียง“อู” หรือ “อือ” หรือ “อา” ได้หรือไม่</p><br>
              <p><strong>ผ่าน:</strong> เด็กทำเสียงอู หรือ อือ หรือ อาอย่างชัดเจน</p>
            </div>
            <div class="accordion" id="training9">
              <div class="accordion-item">
                ...
                <div id="collapse9" class="accordion-collapse collapse" data-bs-parent="#training9">
                  <div class="accordion-body">
                    1. จัดเด็กอยู่ในท่านอนหงาย หรืออุ้มเด็ก<br>
                    2. ยื่นหน้าเข้าไปหาเด็ก สบตาและพูดคุยให้เด็กสนใจ แล้วทำเสียง
                    อู หรือ อือ หรือ อา ในลำคอให้เด็กได้ยิน หยุดฟังเพื่อรอจังหวะให้เด็กส่งเสียงตาม<br>
                    3. เมื่อเด็กออกเสียงได้ ให้ยื่นหน้าห่างจากเด็กเพิ่มขึ้นจนถึงประมาณ60 ซม.
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="card mb-4 shadow-sm">
          <div class="card-header bgeva1 text-white">
            <h5 class="mb-0">ข้อที่ 10 - ยิ้มตอบหรือส่งเสียงตอบได้เมื่อพ่อแม่ ผู้ปกครองหรือผู้ประเมินยิ้มและพูดคุยด้วย(PS)</h5>
          </div>
          <div class="card-body bg-white">
            <div class="mb-3">
              <strong>อายุ:</strong> 1 - 2 เดือน
            ...
            <div class="mb-3">
              <strong>วิธีประเมิน:</strong><br>
              <p class="text-muted">จัดเด็กอยู่ในท่านอนหงายพร้อมก้มหน้าไปใกล้เด็ก ยิ้มและพูดคุยกับเด็ก โดยไม่แตะต้องตัวเด็ก</p>
              <p><strong>ผ่าน:</strong> เด็กสามารถยิ้มตอบหรือส่งเสียงตอบได้</p>
            </div>
            <div class="accordion" id="training10">
              <div class="accordion-item">
                ...
                <div id="collapse10" class="accordion-collapse collapse" data-bs-parent="#training10">
                  <div class="accordion-body">
                    อุ้มเด็กอยู่ในท่านอนหงาย มองตาเด็กและสัมผัสเบา ๆ พร้อมกับพูดคุยกับเด็กเป็นคำพูดสั้น ๆ ซ้ำ ๆ ช้า ๆ เช่น “ว่าไงจ๊ะ.. (ชื่อลูก)..คนเก่ง” “ยิ้มซิ” “เด็กดี” “.. (ชื่อลูก)..ลูกรัก” “แม่รักลูกนะ” หยุดฟัง
                    เพื่อรอจังหวะให้เด็กยิ้มหรือส่งเสียงตอบ เป็นการเสริมสร้างความสัมพันธ์ระหว่างเด็กกับผู้ดูแล เพื่อกระตุ้นพัฒนาการทางอารมณ์
                  </div>
                </div>
              </div>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (passCheckbox && failCheckbox) {
          passCheckbox.addEventListener('change', function() {
            if (this.checked) {
              ...
              // unchecked on desktop -> also clear mobile
      ...
      for (let i = 6; i <= 10; i++) {
        ...
        if (passCheckboxMobile && failCheckboxMobile) {
          // Mobile checkbox events (two-way sync)
          passCheckboxMobile.addEventListener('change', function() {
            if (this.checked) {
              ...
              // unchecked on mobile -> also clear desktop
          ...
          // Also ensure desktop handlers (in case mobile wasn't present earlier)
      ...
      window.addEventListener('pageshow', function(e) {
        // when navigating via back/forward, browsers may restore form state
        // always clear so previous selections are not remembered
        clearCheckboxes();
      });
    
      // Validate all questions selected before actual submit
      document.getElementById('confirmSubmitBtn').addEventListener('click', function() {
        ...
        // Clear any alert and submit the form

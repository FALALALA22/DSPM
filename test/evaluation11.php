      ...
      <div class="d-block d-md-none">
        ...
        <div class="card mb-4 shadow-sm">
          ...
          <div class="card-body bg-white">
            ...
            <div class="mb-3">
              <strong>วิธีประเมิน:</strong><br>
              <p class="text-muted">ถามจากพ่อแม่ ผู้ปกครองหรือผู้ดูแลเด็กว่าเด็กสามารถพูด 2 คำขึ้นไป (ไม่ใช่2 พยางค์) 
                ต่อกันได้หรือไม่ หรือขณะเล่นกับเด็ก พยายามให้เด็กเลียนคำพูดที่เป็นวลี 2 คำขึ้นไป เช่น อาบน้ำ ร้องเพลงอ่านหนังสือ เล่านิทาน</p>

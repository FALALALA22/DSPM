        ...
        <table class="table table-bordered table-striped align-middle">
          ...
          <tbody>
            <tr>
              ...
              <!-- <img src="/image/ball-toy.png" alt="สามบอลผ้าเสียงครง" style="width: 60px; height: 60px;"> -->
            </td>
            <td>
            ...
            <td>
              1. สบตาและพูดคุยกับเด็ก ใช้ริมฝีปากทำเสียง เช่น “จุ๊บจุ๊บ” เดาะลิ้นหรือจับมือเด็กมาไว้ที่ปากแล้วขยับตีปากเบา ๆ กระตุ้นให้ออกเสียง“วา..วา” ให้เด็กดูหลาย ๆ ครั้ง แล้วรอให้เด็กทำตาม จนเด็กสามารถเลียนแบบได้<br>
            ...
            <td>
              นั่งหันหน้าเข้าหาเด็กแล้วเรียกชื่อเด็กเมื่อเด็กมองแล้วหยิบตุ๊กตาผ้าให้เด็กเห็นในระดับสายตาเด็ก กระตุ้นให้เด็กสนใจตุ๊กตาผ้าด้วยคำพูด ถ้าเด็กทำไม่ได้ในครั้งแรก ให้ทำซ้ำได้รวมไม่เกิน 3 ครั้ง<br>
              <strong>ผ่าน:</strong> เด็กสบตากับผู้ประเมิน และมองที่ตุ๊กตาผ้าได้นาน 5 วินาที อย่างน้อย 1ใน 3 ครั้ง
            </td>
            <td>
              1. จัดเด็กนั่งหันหน้าเข้าหาพ่อแม่ ผู้ปกครองหรือผู้ดูแลเด็ก<br>
              2. เรียกชื่อและสบตา พูดคุยกับเด็กเมื่อเด็กมองสบตาแล้ว นำของเล่นมาอยู่ในระดับสายตาเด็ก พูดคุยกับเด็กเกี่ยวกับของเล่น เช่น“วันนี้แม่มีพี่ตุ๊กตามาเล่นกับหนู พี่ตุ๊กตามีผมสีน้ำตาลใส่ชุดสีเขียว”
      ...
      <div class="d-block d-md-none">
        ...
        <div class="card mb-4 shadow-sm">
          ...
          <div class="card-body bg-white">
            ...
            <div class="mb-3">
              <strong>วิธีประเมิน:</strong><br>
              <p class="text-muted">นั่งหันหน้าเข้าหาเด็กแล้วเรียกชื่อเด็กเมื่อเด็กมองแล้วหยิบตุ๊กตาผ้าให้เด็กเห็นในระดับสายตาเด็ก กระตุ้นให้เด็กสนใจตุ๊กตาผ้าด้วยคำพูด ถ้าเด็กทำไม่ได้ในครั้งแรก ให้ทำซ้ำได้รวมไม่เกิน 3 ครั้ง</p>
              <p class="text-muted"><strong>อุปกรณ์:</strong>ตุ๊กตาผ้า</p>
              <p><strong>ผ่าน:</strong> เด็กสบตากับผู้ประเมิน และมองที่ตุ๊กตาผ้าได้นาน 5 วินาที อย่างน้อย 1ใน 3 ครั้ง</p>
            </div>

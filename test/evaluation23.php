  ...
  <div class="container py-5">
    ...
    <form method="POST" action="">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
               ...
               <strong>ผ่าน:</strong> 1. เด็กอ่านหนังสือที่มีภาพอย่างต่อเนื่องจนจบ
              ...
              <td>
                  ...
                  - ให้เด็กเล่าเรื่องที่อ่านให้คนในครอบครัวฟัง โดยผู้ใหญ่แสดงความสนใจและชวนพูดคุยต่อยอดหรือซักถามเด็กเพิ่มเติม เพื่อเสริมสร้างความสัมพันธ์ในครอบครัว<br>
                  3. ชวนเด็กอ่านคำที่เห็นตามสิ่งต่าง ๆ ในชีวิตประจำวัน เช่น ป้ายโฆษณา ป้ายประกาศ ชื่อร้าน ป้ายทางด่วน ป้ายถนน ป้ายซอย เพื่อสร้างบรรยากาศให้รู้จักรักและสนใจการอ่าน
             </td>
            </tr>
            ...
            <tr>
              ...
              <td> สามารถคิดเชิงเหตุผลและอธิบายได้ (EL)<<br><br>
               ...
               - ชุดที่ 1 แม่ไก่ (แม่ไก่ฟักไข่ → ลูกเจี๊ยบ → ไก่ตัวเต็มวัย)<br>
              ...
              <td>
                 ...
                 ชุดที่ 3 ดอกไม้ เริ่มภาพแรกคือ ต้นกล้า จากนั้นให้เด็กเรียงภาพต่อจากแผ่นแรก โดยเรียงลำดับก่อนหลัง และอธิบายสิ่งที่เกิดขึ้นตามลำดับ<br>
                <strong>ผ่าน:</strong> เด็กเรียงลำดับเหตุการณ์และอธิบายเป็นเหตุเป็นผลได้ 2 ใน 3 ชุด

              </td>
              <td>
                 1. ชี้และอธิบายให้เด็กรู้จักสังเกตสิ่งแวดล้อมรอบตัวเด็กที่เปลี่ยนแปลงไปตามระยะเวลา เช่น ตำแหน่งของพระอาทิตย์ที่เปลี่ยนไปในหนึ่งวัน การเจริญเติบโตของพืชที่โตเร็ว เช่น ถั่วงอก ต้นหอม ผักบุ้ง เป็นต้น<br>
                 2. ผู้ใหญ่ถามเด็กด้วยคำถาม เช่น ทำไม อย่างไร เพราะอะไร ฯลฯ แสดงความสนใจต่อคำตอบของเด็ก ชวนพูดคุยและซักถามเพื่อกระตุ้นให้เด็กตอบอย่างมีเหตุผล และช่วยขยายความให้ชัดเจนขึ้น<br>
            ...
            <tr>
              ...
              <td>เทำงานที่ได้รับมอบหมายจนสำเร็จด้วยตนเอง (PS)<br><br>
              
              </td>
              <td>
                ถามจากผู้ปกครอง ผู้ดูแลเด็ก หรือครูประจำชั้นว่า “เด็กสามารถทำงานที่ได้รับมอบหมายจนสำเร็จด้วยตนเองหรือไม่” เช่น การดูแลตนเองในกิจวัตรประจำวัน: แต่งตัว กินข้าว อาบน้ำ แปรงฟันงานด้านการเรียนรู้: วาดรูป อ่าน เขียน ร่วมกิจกรรมงานด้านศิลปะ: ร้องเพลง ออกกำลังกาย<br>
                <strong>ผ่าน:</strong> ผู้ปกครองตอบว่าเด็กสามารถทำงานที่ได้รับมอบหมายจนสำเร็จด้วยตนเอง
              </td>
              <td>
                1. ผู้ใหญ่ปฏิบัติตนเป็นแบบอย่างที่ดีในด้านการทำงานให้เสร็จตามเป้าหมายที่เห็นผลลัพธ์ชัดเจนแก่เด็ก<br>
                2. กำหนดเป้าหมายของงานหรือกิจกรรมร่วมกับเด็ก และสนับสนุนช่วยเหลือให้เด็กทำงานสำเร็จตามเป้าหมายนั้น โดยคำนึงถึงระดับพัฒนาการและความสามารถ<br>
                3. ให้เด็กบอกเป้าหมายในกิจกรรมที่ได้รับมอบหมาย และให้โอกาสเด็กทำเองจนสำเร็จ พร้อมให้ความช่วยเหลือเมื่อเด็กต้องการ<br>
      ...
      <div class="d-block d-md-none">
        ...
        <div class="card mb-4 shadow-sm">
          ...
          <div class="card-body bg-white">
            ...
            <div class="mb-3">
              ...
              <p><strong>ผ่าน:</strong> 1. เด็กอ่านหนังสือที่มีภาพอย่างต่อเนื่องจนจบ 2. เด็กเล่าได้ว่าเป็นเรื่องอะไร</p>
            </div>
              ...
              <div class="accordion-item">
                ...
                <div id="collapse137" class="accordion-collapse collapse" data-bs-parent="#training137">
                  <div class="accordion-body">
                    1. จัดมุมใดมุมหนึ่งของบ้านให้เหมาะสมกับการอ่านหนังสือ แบ่งส่วนสำหรับวางหนังสือของเด็ก และมีหนังสือให้เด็กหยิบเองและวางคืนได้ง่าย<br>
                    2. จัดให้มีช่วงเวลาอ่านหนังสือด้วยตัวเองหรืออ่านกับผู้ใหญ่ เช่น ก่อนนอน หลังอาบน้ำ เวลาว่าง วันหยุดสุดสัปดาห์ เป็นต้น<br>
                    - หนังสือแนะนำ เช่น สวนสัตว์ของป๋องแป๋ง, ป๋องแป๋งแต่งตัว, กุ๋งกิ๋งปวดฟัน, หนูนิดติดเกมส์, ยำยกะตำ<br>
                    - ให้เด็กเล่าเรื่องที่อ่านให้คนในครอบครัวฟัง โดยผู้ใหญ่แสดงความสนใจและชวนพูดคุยต่อยอดหรือซักถามเด็กเพิ่มเติม เพื่อเสริมสร้างความสัมพันธ์ในครอบครัว<br>
                    3. ชวนเด็กอ่านคำที่เห็นตามสิ่งต่าง ๆ ในชีวิตประจำวัน เช่น ป้ายโฆษณา ป้ายประกาศ ชื่อร้าน ป้ายทางด่วน ป้ายถนน ป้ายซอย เพื่อสร้างบรรยากาศให้รู้จักรักและสนใจการอ่าน
                  </div>
                </div>
        ...
        <div class="card mb-4 shadow-sm">
          ...
          <div class="card-body bg-white">
            ...
            <div class="mb-3">
              ...
              ชุดที่ 1 แม่ไก่ เริ่มภาพแรกคือ แม่ไก่ออกไข่<br>
              ชุดที่ 2 ผีเสื้อ เริ่มภาพแรกคือ ไข่ผีเสื้อ<br>
              ชุดที่ 3 ดอกไม้ เริ่มภาพแรกคือ ต้นกล้า จากนั้นให้เด็กเรียงภาพต่อจากแผ่นแรก โดยเรียงลำดับก่อนหลัง และอธิบายสิ่งที่เกิดขึ้นตามลำดับ</p>
              <p><strong>ผ่าน:</strong> เด็กเรียงลำดับเหตุการณ์และอธิบายเป็นเหตุเป็นผลได้ 2 ใน 3 ชุด</p>
            </div>
            <div class="accordion" id="training138">
              <div class="accordion-item">
                ...
                <div id="collapse138" class="accordion-collapse collapse" data-bs-parent="#training138">
                  <div class="accordion-body">
                    1. ชี้และอธิบายให้เด็กรู้จักสังเกตสิ่งแวดล้อมรอบตัวเด็กที่เปลี่ยนแปลงไปตามระยะเวลา เช่น ตำแหน่งของพระอาทิตย์ที่เปลี่ยนไปในหนึ่งวัน การเจริญเติบโตของพืชที่โตเร็ว เช่น ถั่วงอก ต้นหอม ผักบุ้ง เป็นต้น<br>
                    2. ผู้ใหญ่ถามเด็กด้วยคำถาม เช่น ทำไม อย่างไร เพราะอะไร ฯลฯ แสดงความสนใจต่อคำตอบของเด็ก ชวนพูดคุยและซักถามเพื่อกระตุ้นให้เด็กตอบอย่างมีเหตุผล และช่วยขยายความให้ชัดเจนขึ้น
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="card mb-4 shadow-sm">
          <div class="card-header bgeva1 text-white">
            <h5 class="mb-0">ข้อที่ 139 - เทำงานที่ได้รับมอบหมายจนสำเร็จด้วยตนเอง (PS)</h5>
          </div>
          <div class="card-body bg-white">
            <div class="mb-3">
              <strong>อายุ:</strong> 73 - 78 เดือน
            ...
            <div class="mb-3">
              <strong>วิธีประเมิน:</strong><br>
              <p class="text-muted">ถามจากผู้ปกครอง ผู้ดูแลเด็ก หรือครูประจำชั้นว่า "เด็กสามารถทำงานที่ได้รับมอบหมายจนสำเร็จด้วยตนเองหรือไม่" เช่น การดูแลตนเองในกิจวัตรประจำวัน: แต่งตัว กินข้าว อาบน้ำ แปรงฟันงานด้านการเรียนรู้: วาดรูป อ่าน เขียน ร่วมกิจกรรมงานด้านศิลปะ: ร้องเพลง ออกกำลังกาย</p>

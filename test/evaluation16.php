        ...
        <table class="table table-bordered table-striped align-middle">
          ...
          <tbody>
            ...
            <tr>
              ...
              <strong>อุปกรณ์ : รูปภาพตัดออกเป็น3 ชิ้น 1 รูป</strong>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>เขียนรูปวงกลมตามแบบได้ (FM)<br><br>
                <strong>อุปกรณ์ :  1.ดินสอ 2.กระดาษ<br>
                    3. กระดาษที่มีรูปวงกลมขนาดเส้นผ่านศูนย์กลาง 2.5 ซม.ตามแบบ (ใช้สีเส้นวงกลมหนา ๆบนกระดาษขาว)</strong>
                </td>
              <td>
            ...
            <tr>
              ...
              <td>วางวัตถุไว้ข้างหน้าและข้างหลังได้ตามคำสั่ง (RL)<br><br>
                <strong>อุปกรณ์ : 1. ตุ๊กตาผ้า 1 ตัว 2. ก้อนไม้สี่เหลี่ยมลูกบาศก์ 1 ก้อน</strong>
                </td>
              <td>

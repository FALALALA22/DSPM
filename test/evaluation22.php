        ...
        <table class="table table-bordered table-striped align-middle">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                1. ตั้งสิ่งกีดขวาง (เช่น เก้าอี้ กรวย กล่อง)ในแนวตรง ระยะห่าง 1 เมตร จำนวน 3 จุด
                โดยบอกเด็กว่า “เรามาเล่นวิ่งอ้อมสิ่งกีดขวางกันเถอะ”<br>
                2. สาธิตวิธีวิ่งหลบหลีกสิ่งกีดขวางให้เด็กดู<br>
                3. จัดให้เด็กยืนบนพื้นราบและบอกให้เด็กวิ่งหลบหลีกสิ่งกีดขวางแล้วให้เด็กวิ่งกลับมาที่จุดเดิม<br>
                <strong>ผ่าน:</strong>  เด็กวิ่งหลบหลีกสิ่งกีดขวางได้โดยไม่หกล้มหรือชนสิ่งกีดขวาง
              </td>
              <td>
                1. ฝึกเล่นวิ่งซิกแซ็กหลบสิ่งกีดขวางกับเด็ก ให้เด็กรู้จักสังเกตโดยชี้ให้ดูสิ่งกีดขวางว่าจะวิ่งจากไหนไปไหน<br>
                2. สาธิตให้เด็กดู<br>
                3. วิ่งไปพร้อมกับเด็ก<br>
                4. บอกให้เด็กรู้จักจังหวะในการวิ่ง เช่น พูดว่า “หยุด” พร้อมพาเด็ก
                หยุดวิ่ง พูดคำว่า “วิ่งอ้อม” พร้อมพาเด็กวิ่งอ้อมสิ่งกีดขวาง ทำเช่นนี้จนกว่าเด็กวิ่งได้เอง<br>
                5. เมื่อเด็กทำได้ให้เพิ่มสิ่งกีดขวางตามความเหมาะสม<br>
                <strong>หมายเหตุ :</strong> การละเล่นไทยที่มีการวิ่งอ้อมสิ่งกีดขวาง เช่น วิ่งเปี้ยว วิ่งวิบากที่มีการหลบหลีกสิ่งกีดขวาง<br>
                <span style="color: green;"><strong style="color: green;">วัตถุประสงค์ :</strong> เพื่อให้เด็กรู้จักสังเกต วางแผนแก้ไขสถานการณ์และทำงานจนสำเร็จ</span>
            </td>
            </tr>
            ...
            <tr>
              ...
              <img src="../image/evaluation_pic/สามเหลี่ยม.png" alt="Rectangle" style="width: 50px; height: 50px;"><br>
            ...
            <tr>
              ...
              <td>
               ถามเด็กว่า“แม่มีไข่ 5 ฟอง ทอดไข่ให้ลูกกินไปแล้ว 2 ฟอง เหลือไข่กี่ฟอง<br>  
               <strong>ผ่าน:</strong>  ถ้าเด็กสามารถหักลบโดยนับนิ้ว
               หรือสิ่งของออกจากจำนวนไม่เกิน 5 ได้ให้โอกาสตอบ 2 ครั้ง
              </td>
              <td>
                 1. ชวนเด็กนับสิ่งของต่าง ๆ ที่อยู่รอบตัวในชีวิตประจำวัน ของใช้ในบ้าน
                 เช่น ไม้หนีบผ้า โต๊ะ เก้าอี้ จาน ชาม หรือนับของที่แม่ซื้อมาจากตลาด<br>
                 2. คุยและชี้ชวนให้เด็กรู้ว่าของอะไรที่นับจำนวนได้ กับนับไม่ได้ เช่นเก้าอี้นับได้ ทรายนับไม่ได้หรือนับลำบาก แต่ถ้าจะนับต้องบรรจุใน
                 ภาชนะ เช่น ใส่ทรายในถุง ใส่ข้าวสารในถุง แล้วนับเป็นจำนวนถุง<br>
                 3. ชวนเด็กเล่นเกมเกี่ยวกับตัวเลข เช่น เกมจับคู่ภาพกับจำนวน เกมหาเลขคู่ เกมหาเลขคี่ หมากเก็บ เวลานั่งรถชวนลูกให้สังเกตหมายเลขทะเบียน
                 รถและพยัญชนะ ตัวเลขสัญญาณไฟจราจรที่แสดงตัวเลขนับถอยหลัง<br>
                 4. สอนให้เด็กรู้จักการลบ โดยนำสิ่งของชนิดเดียวกัน 2 จำนวนมาหักลบกัน เช่น มีส้ม 5 ลูก กินไป 3 ลูก เหลือส้มกี่ลูก<br>
                 5. เล่นเกมที่ต้องมีการนับจำนวน นับคะแนนการบวก การลบนับเดินหน้านับถอยหลัง<br>
                 6. เล่านิทานและอ่านหนังสือที่มีเนื้อหาเกี่ยวกับตัวเลข<br>
            ...
            <tr>
              ...
              <td>เด็กสามารถบอกชื่อสิ่งของได้ 3 หมวด ได้แก่ สัตว์, เสื้อผ้า, อาหาร (EL)<br><br>
               ...
               <ul>
                ...
                <li>หมวดอาหาร: ปลาทู, ไข่ดาว, ผัดผัก</li><br>
                <img src="../image/evaluation_pic/บัตรภาพจัดประเภทสิ่งของ.png" alt="Rectangle" style="width: 150px; height: 110px;"> 
            </ul>
              </td>
              <td>
            ...
            <tr>
              ...
              <td>
                ถามเด็กว่า 1. “เวลาแปรงฟัน หนูใช้อะไรบ้างคะ”<br>
                2. บีบยาสีฟันให้เด็กขนาดตามความกว้างของแปรง แล้วให้เด็กแปรงฟันให้ดู<br>
                <img src="../image/evaluation_pic/ยาสีฟัน.png" alt="Rectangle" style="width: 150px; height: 110px;"><br>
                <strong>ผ่าน:</strong> เด็กทำได้ทั้งข้อ 1 และข้อ 2 เด็กรู้จักอุปกรณ์ที่ใช้ในการแปรงฟัน ได้แก่ แปรงสีฟันและยาสีฟัน 
                2.เด็กสามารถแปรงฟันโดยขยับแปรงหน้า–หลังสั้น ๆ (Scrub) ครบทุกซี่ทุกด้าน เป็นเวลาอย่างน้อย 2 นาที<br>
                <img src="../image/evaluation_pic/แปรงฟัน.png" alt="Rectangle" style="width: 150px; height: 110px;">
              </td>
              <td>
                ...
                <img src="../image/evaluation_pic/เต็มแปรง.png" alt="Rectangle" style="width: 150px; height: 110px;"><br>
                ...
                การใช้หลอดตัดปลายมนตรวจความสะอาดฟัน <img src="../image/evaluation_pic/ทำความสะอาดฟัน.png" alt="Rectangle" style="width: 150px; height: 110px;"><br>
      ...
      <div class="d-block d-md-none">
        ...
        <div class="card mb-4 shadow-sm">
          ...
          <div class="card-body bg-white">
            ...
            <div class="mb-3">
              ...
              <p class="text-muted">1. ตั้งสิ่งกีดขวาง (เช่น เก้าอี้ กรวย กล่อง)ในแนวตรง ระยะห่าง 1 เมตร จำนวน 3 จุด
                โดยบอกเด็กว่า “เรามาเล่นวิ่งอ้อมสิ่งกีดขวางกันเถอะ”<br>
                2. สาธิตวิธีวิ่งหลบหลีกสิ่งกีดขวางให้เด็กดู<br>
                3. จัดให้เด็กยืนบนพื้นราบและบอกให้เด็กวิ่งหลบหลีกสิ่งกีดขวางแล้วให้เด็กวิ่งกลับมาที่จุดเดิม<br></p>
            ...
            <div class="accordion" id="training131">
              <div class="accordion-item">
                ...
                <div id="collapse131" class="accordion-collapse collapse" data-bs-parent="#training131">
                  <div class="accordion-body">
                    1. ชี้และชวนเด็กดูสิ่งรอบตัวที่เป็นรูปสามเหลี่ยม เช่น หลังคาบ้าน, กระดาษสี่เหลี่ยมพับครึ่งทะแยงมุมเป็นสามเหลี่ยม, ผ้าพันคอ
                    ที่เป็นรูปสามเหลี่ยม, ด้านข้างหมอนขวาน, ธงรูปสามเหลี่ยม<br>
                    2. วาดรูปสี่เหลี่ยมแล้วขีดเส้นทะแยงมุมให้เป็นสามเหลี่ยม 2 อัน ให้เด็กดูแล้วให้เด็กวาดตาม<br>
                    3. เขียนจุดสามจุดแล้วให้เด็กโยงเส้นระหว่างจุดเป็นรูปสามเหลี่ยม แล้วให้เด็กวาดเองโดยไม่ต้องจุดให้ก่อน<br>
        ...
        <div class="card mb-4 shadow-sm">
          ...
          <div class="card-body bg-white">
            ...
            <div class="mb-3">
              <strong>วิธีประเมิน:</strong><br>
              <p class="text-muted">ถามเด็กว่า"แม่มีไข่ 5 ฟอง ทอดไข่ให้ลูกกินไปแล้ว 2 ฟอง เหลือไข่กี่ฟอง</p>
              <p><strong>ผ่าน:</strong> ถ้าเด็กสามารถหักลบโดยนับนิ้ว
               หรือสิ่งของออกจากจำนวนไม่เกิน 5 ได้ให้โอกาสตอบ 2 ครั้ง</p>
            </div>

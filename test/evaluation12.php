      ...
      <div class="d-block d-md-none">
        ...
        <div class="card mb-4 shadow-sm">
          ...
          <div class="card-body bg-white">
            ...
            <div class="mb-3">
              <strong>วิธีประเมิน:</strong><br>
              <p class="text-muted">ถามจากพ่อแม่ ผู้ปกครองหรือผู้ดูแลเด็ก ว่าเด็กสามารถแก้ปัญหาง่าย ๆ ด้วยตนเองโดยใช้เครื่องมือได้หรือไม่ เช่น เวลาเด็กหยิบของไม่ถึงเด็กทำอย่างไร ใช้ไม้เขี่ยใช้เก้าอี้ปีนไปหยิบของ เป็นต้น</p>

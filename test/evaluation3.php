  ...
  <div class="container py-5">
    ...
    <form method="POST" action="">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                3. กระตุ้นให้เด็กมองที่ลูกบอลผ้าเสียงครง<br>
                4. เคลื่อนลูกบอลผ้าเสียงครงเป็นแนวโค้งจากด้านข้างลำตัวไปอีกด้านข้าง<br>
                <strong>ผ่าน:</strong> เด็กมองตามลูกบอลผ้าเสียงครงได้ 180 องศา อย่างน้อย 1 ใน 3 ครั้ง
              </td>
              <td>
                1. จัดให้เด็กอยู่ในท่านอนหงาย<br>
                2. ยื่นหน้าให้ใกล้เด็ก ห่างจากหน้าเด็กประมาณ 30 ซม.<br>
                3. กระตุ้นให้เด็กมองหน้า เมื่อเด็กมองแล้วให้เคลื่อนหน้าจากด้านหนึ่งไปอีกด้านหนึ่ง<br>
                4. ถ้าเด็กยังไม่มองตาม ให้ประคองหน้าเด็กให้หันมองตาม<br>
                5. ฝึกเพิ่มเติมโดยใช้ของเล่นที่มีสีสันสดใสกระตุ้นให้เด็กสนใจและมองตาม<br>
            ...
            <tr>
              ...
              <td>
                1. จัดให้เด็กอยู่ในท่านอนหงาย หรืออุ้มเด็กหันหน้าออกจากผู้ดูแลเด็ก<br>
                2. เขย่าของเล่นให้มีเสียง<br>
                3. เขย่าของเล่นจากด้านข้าง ห่างจากเด็กประมาณ 30 - 45 ซม. และไม่ให้เด็กเห็นของเล่นที่มีเสียง<br>
                4. จากนั้นให้พูดคุยและยิ้มกับเด็ก ถ้าเด็กหันมองของเล่น ให้ประคองช่วยเด็กหันตามเสียงและเห็นของเล่นจนระยะ 60 ซม.<br>
                <strong>ของเล่นที่ใช้แทนได้:</strong> อุปกรณ์ที่มีเสียงดัง เช่น กรุ๊งกริ๊งพลาสติก/ผ้า ขวดพลาสติกใส่เม็ดถั่ว/ทราย พันให้แน่น
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                มองสบตาเด็ก และพูดด้วยเสียงสูง ๆ ต่ำ ๆ เล่นหัวเราะกับเด็ก หรือสัมผัสจุดต่าง ๆ ของร่างกายเด็ก เช่น ใช้นิ้วสัมผัสเบา ๆ ที่ฝ่าเท้า ท้องเอว หรือใช้จมูกสัมผัสหน้าผาก แก้ม จมูก ปากและท้องเด็ก โดยการสัมผัสแต่ละครั้งควรมีจังหวะหนักเบาแตกต่างกันไป
              </td>
            </tr>
      ...
      <div class="d-block d-md-none">
        ...
        <div class="card mb-4 shadow-sm">
          <div class="card-header bgeva1 text-white">
            <h5 class="mb-0">ข้อที่ 12 - มองตามได้ 180 องศา (FM)</h5>
          </div>
          <div class="card-body bg-white">
            <div class="mb-3">
            ...
            <div class="mb-3 text-center">
              <strong>อุปกรณ์:</strong> ลูกบอลผ้าเสียงครง
            </div>
            <div class="mb-3">
              <strong>วิธีประเมิน:</strong><br>
              ...
              3. กระตุ้นให้เด็กมองที่ลูกบอลผ้าเสียงครง<br>
              4. เคลื่อนลูกบอลผ้าเสียงครงเป็นแนวโค้งจากด้านข้างลำตัวไปอีกด้านข้าง<br>
              <strong>ผ่าน:</strong> เด็กมองตามลูกบอลผ้าเสียงครงได้ 180 องศา อย่างน้อย 1 ใน 3 ครั้ง</p>
            </div>
